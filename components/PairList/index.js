    ...
    <ListWrapper>
      ...
      >
        ...
        <Flex alignItems="center">
          ...
          >
            Volume (24hrs)
            {sortedColumn === SORT_FIELD.VOL ? (!sortDirection ? 'â†‘' : 'â†“') : ''}
          </ClickableText>
        </Flex>
        {!below1080 && (
          <Flex alignItems="center" justifyContent="flexEnd">
            ...
            >
              Volume (7d) {sortedColumn === SORT_FIELD.VOL_7DAYS ? (!sortDirection ? 'â†‘' : 'â†“') : ''}
            </ClickableText>
          </Flex>
        )}
        {!below1080 && (
          <Flex alignItems="center" justifyContent="flexEnd">
            ...
            >
              Fees (24hr) {sortedColumn === SORT_FIELD.FEES ? (!sortDirection ? 'â†‘' : 'â†“') : ''}
            </ClickableText>
          </Flex>
        )}
        {!below1080 && (
          <Flex alignItems="center" justifyContent="flexEnd">
            ...
            >
              1y Fees / Liquidity {sortedColumn === SORT_FIELD.APY ? (!sortDirection ? 'â†‘' : 'â†“') : ''}
            </ClickableText>
