    ...
    <ListWrapper>
      <DashGrid center={true} style={{ height: 'fit-content', padding: '0 1.125rem 1rem 1.125rem' }}>
        <Flex alignItems="center" justifyContent="flexStart">
          ...
          >
            {below680 ? 'Symbol' : 'Name'} {sortedColumn === SORT_FIELD.NAME ? (!sortDirection ? 'â†‘' : 'â†“') : ''}
          </ClickableText>
        </Flex>
        {!below680 && (
          <Flex alignItems="center">
            ...
            >
              Symbol {sortedColumn === SORT_FIELD.SYMBOL ? (!sortDirection ? 'â†‘' : 'â†“') : ''}
            </ClickableText>
          </Flex>
        )}
        ...
        <Flex alignItems="center">
          ...
          >
            Liquidity {sortedColumn === SORT_FIELD.LIQ ? (!sortDirection ? 'â†‘' : 'â†“') : ''}
          </ClickableText>
        </Flex>
        <Flex alignItems="center">
          <ClickableText
          ...
          >
            Volume (24hrs)
            {sortedColumn === (useTracked ? SORT_FIELD.VOL_UT : SORT_FIELD.VOL) ? (!sortDirection ? 'â†‘' : 'â†“') : ''}
          </ClickableText>
        </Flex>
        {!below1080 && (
          <Flex alignItems="center">
            ...
            >
              Price {sortedColumn === SORT_FIELD.PRICE ? (!sortDirection ? 'â†‘' : 'â†“') : ''}
            </ClickableText>
          </Flex>
        )}
        {!below1080 && (
          <Flex alignItems="center">
            ...
            >
              Price Change (24hrs)
              {sortedColumn === SORT_FIELD.CHANGE ? (!sortDirection ? 'â†‘' : 'â†“') : ''}
            </ClickableText>
          </Flex>
        )}
      </DashGrid>
