    ...
    <>
      <DashGrid center={true} style={{ height: 'fit-content', padding: '0 0 1rem 0' }}>
        ...
        <Flex alignItems="center" justifyContent="flexStart">
          ...
          >
            Total Value {sortedColumn === SORT_FIELD.VALUE ? (!sortDirection ? 'â†‘' : 'â†“') : ''}
          </ClickableText>
        </Flex>
        {!below780 && (
          <Flex alignItems="center">
            ...
            >
              ...
              {sortedColumn === SORT_FIELD.AMOUNT0 ? (sortDirection ? 'â†‘' : 'â†“') : ''}
            </ClickableText>
          </Flex>
        )}
        <>
          {!below780 && (
            <Flex alignItems="center">
              ...
              >
                ...
                {sortedColumn === SORT_FIELD.AMOUNT1 ? (sortDirection ? 'â†‘' : 'â†“') : ''}
              </ClickableText>
            </Flex>
          )}
          {!below1080 && (
          ...
          <Flex alignItems="center">
            ...
            >
              Time {sortedColumn === SORT_FIELD.TIMESTAMP ? (!sortDirection ? 'â†‘' : 'â†“') : ''}
            </ClickableText>
          </Flex>
        </>
      </DashGrid>
